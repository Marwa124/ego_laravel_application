...
<div class="form-group row ">
  ...
  <div class="col-9">
    {!! Form::textarea('description', null, ['class' => 'form-control','placeholder'=>
     trans("lang.brand_description_placeholder")  ]) !!}
    <div class="form-text text-muted">{{ trans("lang.brand_description_help") }}</div>
  </div>
</div>
</div>
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
...
<div class="form-group row">
  ...
  <div class="col-9">
    <div style="width: 100%" class="dropzone image" id="image" data-brand="image">
...
<script type="text/javascript">
    ...
    var dz_var15866134631720934041ble = $(".dropzone.image").dropzone({
        ...
        removedfile: function (file) {
            dzRemoveFile(
                file, var15866134631720934041ble, '{!! url("brands/remove-media") !!}',
