...
function load_cats( $selected = null, $cat_disabled = null ) {
    $cats = Category::all();
    $cat_arr = [];
    foreach ( $cats as $cat ) {
        $list_ar = [];
        ...
        $list_ar['li_attr'] = '';
        $list_ar['icon'] = '';
        if ( $selected != null && $selected == $cat->id ) {
            $list_ar['state'] = [
                'opened'=>true,
                'selected'=>true,
                'disabled'=>false,
        ...
        if ( $cat_disabled != null && $cat_disabled == $cat->id ) {
            $list_ar['state'] = [
                'opened'=>false,
                'selected'=>false,
                'disabled'=>true,
        ...
        $list_ar['id'] = $cat->id;
        $list_ar['parent'] = $cat->parent != null? $cat->parent : '#';
        $list_ar['text'] = $cat->name;
        array_push( $cat_arr, $list_ar );
